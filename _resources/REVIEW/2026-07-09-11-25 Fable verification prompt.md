# Fable Verification Prompt — Residale Config
...
- Worktree: `/home/hermes/workspace/residale/residale-config`.
- Repo: `Residale/residale-config`.
- Production URL: `https://config.residale.com`.

Context:

- Hermes/controller already completed and pushed commit `08707f7 Modernize Residale Config and add architect sheet export`.
...
2. Residale Config branding is consistent enough for this slice.
